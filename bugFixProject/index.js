...
//The line above was previously commented, I'm taking that as intended since there are otherwise no errors in the code.
//The issue was that a parenthesis was missing. Solved
...
//There was no variable being declared besides the previous 'message', which does not read as the intended variable.
//Error:Missing variable. I created a variable. Solved
...
//used variable as variable. solved
...
//attempted to grab user variable instead of properties
//changed user to user.name+age. Solved
...
//Error:string used instead of number value
//changed string to num. Solved
